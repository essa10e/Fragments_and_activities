...
public class Tab2Fragment extends Fragment {
    private final String TAG = "Fragment TAB 1";

    private Button btnNavFragment2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnNavFragment2 = (Button)view.findViewById(R.id.btnNavFrag2);

        Log.d(TAG, "onCreateView started.");

        btnNavFragment2.setOnClickListener(new View.OnClickListener() {
            @Override
